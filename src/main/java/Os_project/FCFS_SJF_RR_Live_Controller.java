...
public class FCFS_SJF_RR_Live_Controller implements Initializable {
    ...
    public FCFS_SJF_RR_Live_Controller(TreeItem<RowRecord>[] Row, Scheduler scheduler) {
        this.Row = Row;
    ...
    void updateRemainingTime(String processName) {
        if (!processName.equals("N")) {
            ...
            int newRTValue = process.getValue().getRemainingTime() - 1;
